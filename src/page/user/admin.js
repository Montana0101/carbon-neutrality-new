...
var xx = [
  {
    id: 23,
    consultTime: "2022-06-10 11:13:56",
    phone: "1563949380",
    status: 0,
    consultContent: "咨询",
    consultCompany: "大公司呀",
  ...
  {
    id: 24,
    consultTime: "2022-06-10 11:14:14",
    phone: "1563949380",
    status: 0,
    consultContent: "咨询一下",
    consultCompany: "大头公司",
  ...
  {
    id: 25,
    consultTime: "2022-06-10 11:14:30",
    phone: "1563949380",
    status: 0,
    consultContent: "咨询一下出发",
    consultCompany: "天黑了",
    operater: null,
    updateTime: null,
    index: 3,
  ...
  {
    id: 26,
    consultTime: "2022-06-10 11:16:17",
    phone: "1563949380",
    status: 0,
    consultContent: "联盟科技",
    consultCompany: "联盟科技",
  ...
  {
    id: 28,
    consultTime: "2022-06-10 14:29:40",
    phone: "15629797423",
    status: 0,
    consultContent: "感兴趣，请回复",
    consultCompany: "大白公司",
    operater: null,
    updateTime: null,
    index: 5,
...
function Admin(props) {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record, index) => {
        return (
          <span style={{ color: statusValue(text).color }}>
            {statusValue(text).name}
          </span>
        );
      },
    },
          ...
          >
            ...
            {record.status === 2 && (
              <Popconfirm
                ...
                okText="确定"
                cancelText="取消"
                onConfirm={() => _rejectUser([record.id])}
              >
                {ButtonCmt("#FD867F", "white", "驳回")}
              </Popconfirm>
            )}
            ...
            {record.status === 3 && (
              <Popconfirm
                ...
                okText="确定"
                cancelText="取消"
                onConfirm={() => _disableUser(record.id)}
              >
                {ButtonCmt("#EFA71C", "white", "禁用")}
              </Popconfirm>
            )}
            ...
            {record.status === 5 && (
              <Popconfirm
                ...
                okText="确定"
                cancelText="取消"
                onConfirm={() => _restartUser(record.id)}
              >
                {ButtonCmt("#418DF5", "white", "启用")}
              </Popconfirm>
            )}
          </div>
        );
                ...
                <Row>
                  <Form.Item label="用户状态">
                    ...
                    >
                      ...
                      <Radio.Button value={4} key={3}>
                        已驳回
                      </Radio.Button>
                      <Radio.Button value={3} key={4}>
                        已通过
                      </Radio.Button>
                ...
                <Row>
                  <Col span={11}>
                    <Form.Item label="审核日期">
                      <DatePicker.RangePicker
                        style={{ width: "100%" }}
                        onChange={(moment, str) => setApproval(str)}
                        locale={locale}
                      />
                    </Form.Item>
                  </Col>
                  ...
                  <Col span={11}>
                    <Form.Item label="申请日期">
                      <DatePicker.RangePicker
                        style={{ width: "100%" }}
                        onChange={(moment, str) => setApply(str)}
                        locale={locale}
                      />{" "}
                    </Form.Item>
                  </Col>
                ...
                <Row>
                  <Col span={11}>
                    <Form.Item label="咨询日期">
                      <DatePicker.RangePicker
                        style={{ width: "100%" }}
                        onChange={(moment, str) => setConsult(str)}
                        locale={locale}
                      />
                    </Form.Item>
                  </Col>
