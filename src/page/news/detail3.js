    ...
    return (
        <div className="new3" style={{
            ...
            <div style={{
                ...
                <article style={{
                    ...
                    <div id="u20_text" className="text ">
                        <p style={{ fontSize: '0.17rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}>&nbsp;&nbsp; &nbsp;
            &nbsp;&nbsp; </span><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300, fontSize: '0.16rem' }}>实现碳达峰、碳中和，是以习近平同志为核心的党中央统筹国内国际两个大局作出的重大战略决策，是着力解决资源环境约束突出问题、实现中华民族永续发展的必然选择，是构建人类命运共同体的庄严承诺。为完整、准确、全面贯彻新发展理念，做好碳达峰、碳中和工作，现提出如下意见。</span>
                        </p>
                        <p style={{ fontSize: '0.17rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}><br /></span></p>
                        <p style={{ fontSize: '0.17rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}>&nbsp;&nbsp; &nbsp;
            &nbsp;&nbsp; </span><span style={{ fontFamily: '"思源宋体 CN Bold", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 700 }}>一、总体要求</span></p>
                        <p style={{ fontSize: '0.17rem' }}><span style={{ fontFamily: '"思源宋体 CN Bold", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 700 }}><br /></span></p>
                        <p style={{ fontSize: '0.17rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}>&nbsp;&nbsp; &nbsp;
          </span><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300, fontSize: '0.16rem' }}>（一）指导思想</span>
                        </p>
                        <p style={{ fontSize: '0.16rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}>&nbsp;&nbsp; &nbsp;
                        &nbsp;
            以习近平新时代中国特色社会主义思想为指导，全面贯彻党的十九大和十九届二中、三中、四中、五中全会精神，深入贯彻习近平生态文明思想，立足新发展阶段，贯彻新发展理念，构建新发展格局，坚持系统观念，处理好发展和减排、整体和局部、短期和中长期的关系，把碳达峰、碳中和纳入经济社会发展全局，以经济社会发展全面绿色转型为引领，以能源绿色低碳发展为关键，加快形成节约资源和保护环境的产业结构、生产方式、生活方式、空间格局，坚定不移走生态优先、绿色低碳的高质量发展道路，确保如期实现碳达峰、碳中和。</span>
                        ...
                        <p style={{ fontSize: '0.16rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}><br /></span></p>
                        <p style={{ fontSize: '0.16rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}>&nbsp;&nbsp; &nbsp;
            （二）工作原则</span></p>
                        <p style={{ fontSize: '0.16rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}>&nbsp;&nbsp; &nbsp;
            ...
            &nbsp; ——防范风险。处理好减污降碳和能源安全、产业链供应链安全、粮食安全、群众正常生活的关系，有效应对绿色低碳转型可能伴随的经济、金融、社会风险，防止过度反应，确保安全降碳。</span></p>
                        <p style={{ fontSize: '0.16rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}><br /></span></p>
                        <p style={{ fontSize: '0.17rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}><br /></span></p>
                        <p style={{ fontSize: '0.17rem' }}><span style={{ fontFamily: '"思源宋体 CN Bold", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 700 }}>&nbsp;&nbsp; &nbsp;
            &nbsp;&nbsp; 二、主要目标</span></p>
                        <p style={{ fontSize: '0.17rem' }}><span style={{ fontFamily: '"思源宋体 CN Bold", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 700 }}><br /></span></p>
                        <p style={{ fontSize: '0.16rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}>&nbsp;&nbsp; &nbsp;
            ...
            到2025年，绿色低碳循环发展的经济体系初步形成，重点行业能源利用效率大幅提升。单位国内生产总值能耗比2020年下降13.5%；单位国内生产总值二氧化碳排放比2020年下降18%；非化石能源消费比重达到20%左右；森林覆盖率达到24.1%，森林蓄积量达到180亿立方米，为实现碳达峰、碳中和奠定坚实基础。</span>
                        ...
                        <p style={{ fontSize: '0.16rem' }}><span style={{ fontFamily: '"思源宋体 CN Bold", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 700 }}><br /></span></p>
                        <p style={{ fontSize: '0.16rem' }}><span style={{ fontFamily: '"思源宋体 CN Bold", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 700 }}>&nbsp;&nbsp; &nbsp;
                        &nbsp;&nbsp;
            ...
            &nbsp; 三、推进经济社会发展全面绿色转型</span></p>
                        <p style={{ fontSize: '0.17rem' }}><span style={{ fontFamily: '"思源宋体 CN Bold", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 700 }}><br /></span></p>
                        <p style={{ fontSize: '0.17rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}>&nbsp;</span><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300, fontSize: '0.16rem' }}>&nbsp;
                        &nbsp; &nbsp;
            ...
            &nbsp;&nbsp; 五、加快构建清洁低碳安全高效能源体系</span></p>
                        <p style={{ fontSize: '0.17rem' }}><span style={{ fontFamily: '"思源宋体 CN Bold", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 700 }}><br /></span></p>
                        <p style={{ fontSize: '0.17rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}>&nbsp;&nbsp; &nbsp;&nbsp;
          </span><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300, fontSize: '0.16rem' }}>（九）强化能源消费强度和总量双控。坚持节能优先的能源发展战略，严格控制能耗和二氧化碳排放强度，合理控制能源消费总量，统筹建立二氧化碳排放总量控制制度。做好产业布局、结构调整、节能审查与能耗双控的衔接，对能耗强度下降目标完成形势严峻的地区实行项目缓批限批、能耗等量或减量替代。强化节能监察和执法，加强能耗及二氧化碳排放控制目标分析预警，严格责任落实和评价考核。加强甲烷等非二氧化碳温室气体管控。</span>
                        </p>
                        <p style={{ fontSize: '0.16rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}><br /></span></p>
                        <p style={{ fontSize: '0.16rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}>&nbsp;&nbsp; &nbsp;&nbsp;
            ...
            （十九）加快优化建筑用能结构。深化可再生能源建筑应用，加快推动建筑用能电气化和低碳化。开展建筑屋顶光伏行动，大幅提高建筑采暖、生活热水、炊事等电气化普及率。在北方城镇加快推进热电联产集中供暖，加快工业余热供暖规模化发展，积极稳妥推进核电余热供暖，因地制宜推进热泵、燃气、生物质能、地热能等清洁低碳供暖。</span>
                        ...
                        <p style={{ fontSize: '0.16rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}><br /></span></p>
                        <p style={{ fontSize: '0.16rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}><br /></span></p>
                        <p style={{ fontSize: '0.17rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}>&nbsp; </span><span style={{ fontFamily: '"思源宋体 CN Bold", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 700 }}>&nbsp; &nbsp;&nbsp;
            ...
            十一、健全法律法规标准和统计监测体系</span></p>
                        <p style={{ fontSize: '0.17rem' }}><span style={{ fontFamily: '"思源宋体 CN Bold", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 700 }}><br /></span></p>
                        <p style={{ fontSize: '0.17rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}>&nbsp;&nbsp; &nbsp;
          </span><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300, fontSize: '0.16rem' }}>（二十七）健全法律法规。全面清理现行法律法规中与碳达峰、碳中和工作不相适应的内容，加强法律法规间的衔接协调。研究制定碳中和专项法律，抓紧修订节约能源法、电力法、煤炭法、可再生能源法、循环经济促进法等，增强相关法律法规的针对性和有效性。</span>
                        </p>
                        <p style={{ fontSize: '0.16rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}><br /></span></p>
                        <p style={{ fontSize: '0.16rem' }}><span style={{ fontFamily: '"思源宋体 CN Light", "思源宋体 CN Regular", "思源宋体 CN"', fontWeight: 300 }}>&nbsp;&nbsp; &nbsp;
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; 来源：新华社</span></p>
                ...
                <div style={{
                    ...
                    <span onClick={() => {
                        history.push("/news/2")
                    }}>上一篇&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; 上海碳中和技术创新联盟发起人会议在新能源中心召开</span>
                    <span></span>
                </div>
            </div>
        </div>
