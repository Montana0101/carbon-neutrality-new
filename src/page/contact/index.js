...
const ContactUs = () => {
    ...
    return <div style={{
        height: "100%", width: "100%", position: "relative", border: "1px solid red",
        ...
        <div style={{
            ...
            <section style={{
                ...
                <div style={{
                    border: "1px solid red", height: '100%', paddingRight: "0.5rem",
                ...
                <div style={{
                    border: "1px solid red", height: '100%', paddingLeft: "0.5rem",
