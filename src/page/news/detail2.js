        ...
        <div className="screen_1" style={{
            ...
            <div style={{
                ...
                <article style={{
                    ...
                    <img style={{margin:"0.2rem auto",width:"40%"}} src={img3}/>                  <p style={{fontWeight:"bold"}}>新能源中心黄瓒主任代表发起人单位表态，未来联盟将牢记领导的嘱托，全面贯彻落实国家和上海地方“碳达峰、碳中和”战略部署，以“双碳”领域技术创新需求和成果转化需求为导向，集中大力攻关，加快推进核心技术的突破与产业化，推动相关产业爆发式增长，打造国内一流、国际领先的碳中和科技创新平台，催生新的业态并引领发展。</p>
                    <p style={{fontWeight:"bold"}}>未来新能源中心将与各位发起人一道，凝聚各方力量，高质量建设联盟，不断赋能，建立高效机制，通过联盟这一综合性平台，全力以赴，扎实推动上海“双碳”科技事业蓬勃发展。</p>
                ...
                <div style={{
                   ...
                   <span onClick={()=>{
                    history.push("/news/1")
                }}>上一篇&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; 沪科〔2021〕497号 关于同意成立上海碳中和技术创新联盟的批复</span>
                   <span onClick={()=>{
                    history.push("/news/3")
                }}>下一篇&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; 中共中央国务院关于完整准确全面贯彻新发展理念...</span>
                </div>
            </div>
        </div>
    )
